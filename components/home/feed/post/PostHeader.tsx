  ...
  return (
    <>
     <div className='border-b border-grat-light-text items-center flex justify-between   px-3'>
          ...
          <button className='h-[50px] w-[50px] rounded-full hover:bg-grat-light-gray flex items-center justify-center'><span className='text-grat-black text-xl'><FaTimes/></span></button>
      </div>
